...
return [
    ...
    'udp' => [
        ...
        'events' => [
            ['packet', \App\Ext\UdpServe::class, 'onPacket'],
        ],
        'settings' => [],
    ],
    'tcp' => [
        ...
        'events' => [
            ['receive', \App\Ext\Tcp\TcpServe::class, 'onReceive'],
        ],
        'settings' => [],
    ],
    'ws' => [
...
//            ['open', \Sapi\Events::class, 'onOpen'],
            ['handshake', \App\Ext\ChatEvents::class, 'onHandshake'],
...
//            'dispatch_mode' => 2,//数据包分发策略。【默认值：2】
            ...
            'log_file' => 'storage/swoole_log/swoole',
